    ...
    <div className="flex flex-col min-h-screen bg-blue-200">
      ...
      <main className="flex-1">
        ...
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden px-4">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-[500px] bg-linear-to-b from-blue-100 via-emerald-50 to-transparent rounded-full blur-3xl -z-1"></div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h1 className="text-4xl md:text-6xl font-black text-gray-900 tracking-tight leading-[1.1]">
              ...
              <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-600 via-emerald-500 to-emerald-400">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
              <Link href="/register" className="px-6 py-2 rounded-full bg-blue-600 text-white font-bold text-lg hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-200 hover:scale-105 transition duration-300">
                Mulai Mencari Talenta
              </Link>
              <Link href="/register" className="px-6 py-2 rounded-full bg-white text-gray-800 border-2 border-gray-200 font-bold text-lg hover:border-gray-300 hover:bg-gray-50 hover:scale-105 transition duration-300">
                Pekerjaan Freelance
              </Link>
            </div>
          </div>
        ...
        <section id="cara-kerja" className="py-24 bg-white px-4 border-t border-gray-100">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto relative">
              ...
              <div className="hidden md:block absolute top-[40px] left-1/6 right-1/6 h-[2px] bg-linear-to-r from-gray-200 via-gray-300 to-gray-200 z-0"></div>
        ...
        {/* FINAL CTA */}
        <section className="py-24 bg-linear-to-br from-blue-600 to-indigo-400 px-4 text-center relative overflow-hidden">
